                    ...
                    <div class="container mt-5">
                                    ...
                                    <div class="card h-100 shadow-sm border-0 rounded">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">
                                                ...
                                                <strong class="{{ $livre->disponible ? 'text-success' : 'text-danger' }}">
                                            ...
                                            <div
                                                ...
                                                <form action="{{ route('frontOffice.favoris.retirer', $livre->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                            ...
                            @empty
                                <div class="col-12">
                                    <div class="alert alert-info text-center">
                                        ...
                                        <p class="mt-3">
                                            <a href="{{ route('frontOffice.accueil') }}" class="btn btn-primary">
                        ...
                        @if ($favoris->hasPages())
                            <div class="d-flex justify-content-center mt-4">
                                {{ $favoris->appends(request()->query())->links('pagination::bootstrap-4') }}
                            </div>
                        @endif
